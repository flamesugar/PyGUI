...
class PhotometryViewer:
    ...
    def highlight_artifacts(self):
        ...
        # Count artifacts
        artifact_count = np.sum(self.artifact_mask)

        # Temporarily increase the size and opacity of artifact markers
        ...
        messagebox.showinfo("Artifacts", f"{artifact_count} artifacts detected.\n\n"
                                         f"Current threshold: {self.artifact_threshold}\n\n"
                                         "Artifacts are shown as red dots on both plots.")
        ...
        try:
            ...
            if self.drift_curve is not None and self.drift_correction:
                try:
                    ...
                    # Update legend with new drift line
                    self.ax1_legend = self.create_checkbox_legend(self.ax1)
                except Exception as e:
